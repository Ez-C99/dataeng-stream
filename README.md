...
**Note**: Checkout [Makefile](https://github.com/Ez-C99/dataeng-stream-project/blob/main/Makefile) to see how/what commands are run. Use `make down` to spin down the containers.
